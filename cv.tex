...
\begin{cvheader}{Bartłomiej Leks}
    \begin{contactdetails}
        \item \email{bartlomiej.leks@gmail.com}
        \item \phone{78\,333\,88\,13}
        \item \githubpages{skel21}
        \item \linkedin{bartlomiej-leks}
    \end{contactdetails}
    \begin{contactdetails}
        \item \nationality{Polish}
...
\begin{cvsection}{Work Experience}
    \experience{Research Assistant, ETH Zurich}{Sep 2024 --- Jun 2025}
    \begin{descrlist}
...
\begin{cvsection}{Education}
    \experience{M.Sc. Materials Science, ETH Zurich}{Sep 2024 --- present}
    \begin{descr}
